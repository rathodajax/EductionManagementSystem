...
Public Class Student_Info
    ...
    Private Sub Student_Info_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        sql = "select receipt_no,taken_for,fee_date,fee_tot from fees_master where stu_id=" & lblsid.Text & " order by taken_for desc"
        connect()
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        sql = "select stu_id,receipt_no,taken_for,fee_date,tui_fee,lib_fee,stu_act_fee,uni_fee,lab_fee,fee_tot from fees_master where stu_id=" & Val(lblsid.Text) & ""
        connect()
        da.Fill(ds, "FEES_MASTER")
