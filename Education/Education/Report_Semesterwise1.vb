...
Public Class Report_Semesterwise82
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Report_Semesterwise.rpt"
        End Get
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Education.Report_Semesterwise.rpt"
        End Get
        Set(ByVal value As String)
            'Do nothing
        End Set
...
Public Class CachedReport_Semesterwise82
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Semesterwise = New Report_Semesterwise
        rpt.Site = Me.Site
        Return rpt
    End Function
