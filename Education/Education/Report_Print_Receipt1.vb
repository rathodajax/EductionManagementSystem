...
Public Class Report_Print_Receipt81
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "Report_Print_Receipt.rpt"
        End Get
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Education.Report_Print_Receipt.rpt"
        End Get
        Set(ByVal value As String)
            'Do nothing
        End Set
...
Public Class CachedReport_Print_Receipt81
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Report_Print_Receipt = New Report_Print_Receipt
        rpt.Site = Me.Site
        Return rpt
    End Function
